...
import { Heading, Text, Flex, ChevronRightIcon } from '@paniniswap/paniniswap-uikit'
  ...
  return (
    <>
      ...
      <Text as="p">
        {TranslateString(
          999,
          'Pancake Collectibles are special ERC-721 NFTs that can be used on the Paniniswap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
