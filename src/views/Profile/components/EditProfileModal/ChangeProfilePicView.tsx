...
import { Button, InjectedModalProps, Skeleton, Text } from '@paniniswap/paniniswap-uikit'
...
const ChangeProfilePicPage: React.FC<ChangeProfilePicPageProps> = ({ onDismiss }) => {
  ...
  const paniniRabbitsContract = usePancakeRabbits()
  ...
  const {
    ...
    onApprove: () => {
      return paniniRabbitsContract.methods.approve(getPancakeProfileAddress(), tokenId).send({ from: account })
    },
    onConfirm: () => {
      if (!profile.isActive) {
