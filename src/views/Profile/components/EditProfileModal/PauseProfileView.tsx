...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@paniniswap/paniniswap-uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const paniniProfileContract = useProfileContract()
