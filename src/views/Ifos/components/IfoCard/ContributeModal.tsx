...
import { Modal, LinkExternal, Box } from '@paniniswap/paniniswap-uikit'
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      <Box width="344px">
        ...
        />
        <LinkExternal
          href="https://exchange.paniniswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82"
