...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@paniniswap/paniniswap-uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.paniniswap.finance/#/swap" mr="16px">
              {TranslateString(1060, 'Buy CAKE')}
            </LinkExternal>
            <LinkExternal href="https://exchange.paniniswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.paniniswap.finance/core-products/ifo-initial-farm-offering"
            >
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with Paniniswap, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
